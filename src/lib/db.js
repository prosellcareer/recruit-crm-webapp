...
function candidateToRow(service, c) {
  return {
    ...
    inflow_job_posting: c.inflowJobPosting || "",
    procell_application_count: c.procellApplicationCount || "",
    procell_document_passed_count: c.procellDocumentPassedCount || "",
    procell_interview_confirmed_count: c.procellInterviewConfirmedCount || "",
    procell_interview_passed_count: c.procellInterviewPassedCount || "",
    procell_offer_count: c.procellOfferCount || "",
    cohort_month: c.cohortMonth || "",
    show_in_follow_up_list: c.showInFollowUpList !== false,
...
function rowToCandidate(row) {
  return {
    ...
    inflowJobPosting: row.inflow_job_posting || "",
    procellApplicationCount: row.procell_application_count || "",
    procellDocumentPassedCount: row.procell_document_passed_count || "",
    procellInterviewConfirmedCount: row.procell_interview_confirmed_count || "",
    procellInterviewPassedCount: row.procell_interview_passed_count || "",
    procellOfferCount: row.procell_offer_count || "",
    cohortMonth: row.cohort_month || "",
    showInFollowUpList: row.show_in_follow_up_list !== false,
